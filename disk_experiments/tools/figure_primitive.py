...
def fig_primitive_plan_05():
    ...
    fig.savefig( os.path.dirname(my_path) + "/figures/primitive_05.eps", bbox_inches="tight", pad_inches=0.05)
    # plt.title("Density="+str(Density))
    plt.show()
    # plt.cla()


def fig_primitive_plan_03():
    Compared_Methods = [
        "BST_SP_TB", 
        "BST_SP_RB", 
        # "BST_SP_RB_random_buffer_initiation", 
    ...
    # Here, we setup the style for an algorithm. Let's call it Alg.1.
    alg1Style = deepcopy(defaultStyle)          # First copy all default styles.
    alg1Style['label'] = r'\textsc{TBM-SP-BST}'    # Setup algorithm name. 
                                                # We use \textsc here which is a latex command. 
                                                # This is fine since we use latex to generate text.
    alg1Style['color'] = 'tab:blue'           # Customized line color
                                                # https://matplotlib.org/3.1.0/gallery/color/named_colors.html
    ...
    # Directly save the figure to a file.
    fig.savefig( os.path.dirname(my_path) + "/figures/primitive_03.eps", bbox_inches="tight", pad_inches=0.05)
    # plt.title("Density="+str(Density))
    plt.show()
    # plt.cla()
...
if __name__ == '__main__':
    fig_primitive_plan_03()
    fig_primitive_plan_05()