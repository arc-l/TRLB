...
def main():        
    dir_name = "/home/kai/Documents/Kai_Gao/extend_active_buffer_planning/disk_experiments/paper_experiments/arrangements"
...
def transform_data(Density, numobjs, id, Width, Height, point_list):
    data = {}
    data['Object_Shape'] = 'disc'
    data['Workspace_Density'] = Density
    data['number_of_objects'] = numobjs
    data['Object_Radius'] = math.sqrt( Density * Width * Height/numobjs/math.pi)
    ...
    with open(file_name, 'r') as f:
        for line in f.readlines():
            ...
            if line == 'objects\n':
                ...
                pose = line.split()
                object_list.append((float(pose[0]), float(pose[1])))
    return object_list
