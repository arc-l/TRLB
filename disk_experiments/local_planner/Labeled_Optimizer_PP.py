...
class Labeled_Optimizer_PP(object):
    '''
        ...
        while timeout >0:
            ...
            for SCC_index in SCC_ordering:
                ...
                if self.IsComplexSCC(sub_DG):
                    ...
                    self.action_list.extend(preprocess.transitions)
                ...
                self.action_list.extend(transitions)
                if not self.isfeasible: # subproblem fails
                    break
            else:
                success = True 
                break
